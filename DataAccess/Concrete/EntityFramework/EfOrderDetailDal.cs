...
{
    public class EfOrderDetailDal : EfEntityRepositoryBase<OrderDetail, ApplicationDbContext>, IOrderDetailDal
    {
        public List<DeliveredDto> GetAllDeliveredDTO(Expression<Func<DeliveredDto, bool>> filter = null)
        {
            using (ApplicationDbContext context = new ApplicationDbContext())
            {
                var result = from o in context.Orders
                             ...
                             join i in context.Products on od.ProductId equals i.Id
